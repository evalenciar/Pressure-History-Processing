...
results_folder = 'rainflow_results (No Excel)'
...
for idx, dent in df_dents.iterrows():
    ...
    starttime = time.time()
    try:
        abs_dist = dent['Absolute Distance [m]']
        ...
        dd = rfa.DentData(
            ...
            Lx = dent['Absolute Distance [m]'] * 3.28084,  # Convert meters to feet
            hx = dent['Elevation [m]'] * 3.28084,  # Convert meters to feet
